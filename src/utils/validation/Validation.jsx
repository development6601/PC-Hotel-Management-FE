...
export const settingCustomerValidation = Yup.object({
    ...
    idProofNumber: Yup.string().matches(/^[0-9]{12}$/, "Value must be 12 digits").required("Value is required"), email: Yup.string().email("Invalid email").required("Please enter your email"),
